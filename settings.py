...
PLAYER_SPEED = 400  # Player movement speed (Default: 400)
...
NPC_DATA = {
    "Ariana": {
        ...
        "graphic": "graphics/objects/pixel-anime-blond-girl-cute-student-character-green-skirt-221457120.png",  # Placeholder using existing asset (Default: "graphics/objects/merchant.png")
        "dialogue": [
